...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.port_label = QLabel('Default port number:', self)
        ...
        self.ip_label = QLabel('Server bind IP address:', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        self.ip_label_note = QLabel(
            ' leave this field empty to listen\n on all available addresses.',
            self)
